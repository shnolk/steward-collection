        ...
        <Dialog as="div" class="relative z-40 lg:hidden" @close="open = false">
          ...
          <div class="fixed inset-0 z-40 flex">
            <TransitionChild as="template" enter="transition ease-in-out duration-300 transform" enter-from="-translate-x-full" enter-to="translate-x-0" leave="transition ease-in-out duration-300 transform" leave-from="translate-x-0" leave-to="-translate-x-full">
              <DialogPanel class="relative flex w-full max-w-lg flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                    ...
                    <TabPanel v-for="category in navigation.categories" :key="category.name" class="space-y-10 px-4 pt-10 pb-8">
                      <div class="grid grid-cols-2 gap-x-4">
                        <div v-for="item in category.featured" :key="item.name" class="group relative text-sm">
                          ...
                          <p aria-hidden="true" class="mt-1">View All</p>
                        </div>
                      </div>
                        ...
                        <div class="relative bg-white z-50">
                          <div class="mx-auto px-28">
                            <div class="grid grid-cols-3 gap-y-10 gap-x-8 py-16">
                              ...
                              <div class="row-start-1 grid grid-cols-4 gap-y-10 gap-x-8 text-sm col-span-2">
                                <div v-for="section in category.sections" :key="section.name">
        ...
        featured: [
          {
            name: 'Bags',
            href: '#',
            imageSrc: 'https://us.louisvuitton.com/images/is/image/lv/1/PP_VP_L/louis-vuitton-neverfull-mm-monogram-handbags--M40995_PM2_Front%20view.jpg?wid={IMG_WIDTH}&hei={IMG_HEIGHT}',
            imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
          },
          {
            name: 'Dresses',
            href: '#',
            imageSrc: 'https://global-uploads.webflow.com/6256995755a7ea0a3d8fbd11/625fe29b9805285afd9af6ca_60f549f0a71176e4a9edab9c_Group%25201-p-1080.png',
