      ...
      <div>
        ...
        <TransitionRoot as="template" :show="mobileFiltersOpen">
          ...
          <div class="flex items-baseline justify-between border-b border-gray-200 py-6">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900">All Items</h1>
          ...
          <section aria-labelledby="products-heading" class="pt-6 pb-24">
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div class="lg:col-span-3">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 xl:gap-x-4">
